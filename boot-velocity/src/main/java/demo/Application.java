...
/**
 * Represents one (very under-specified) <em>booking</em> for a named person at
 * a theoretical establishment like a restaurant.
 */
@Entity
class Booking {
...
/**
 * Spring Data JPA-powered <em>repository</em> interface. Supports common
 * operations like {@link #findAll()} and {@link #save(Object)} against JPA
 * entities. This particular repository deals in {@link demo.Booking booking}
 * objects.
 */
...
class BookingHtmlController {
	...
	String all(Model model) {
		model.addAttribute("bookings", mapList(this.bookingRepository.findAll()));
		return "bookings";
	}
}
